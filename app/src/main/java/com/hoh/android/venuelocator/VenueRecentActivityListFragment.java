...
public class VenueRecentActivityListFragment extends Fragment {
    ...
    public static VenueRecentActivityListFragment newInstance(String param1, String param2) {
        VenueRecentActivityListFragment fragment = new VenueRecentActivityListFragment();
    ...
    public VenueRecentActivityListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_venue_recent_activity_list, container, false);
